...
function AdminSettings() {
  ...
  const SETTINGS_SECTIONS: SettingSectionItem[] = useMemo(() => [
    ...
    },
    {
      ...
      description: "Choose how customers interact with your store: Full Online Checkout, Hybrid WhatsApp, WhatsApp Deep-Link Only, or Catalog Showcase Only.",
      keywords: ["ordering mode", "whatsapp order", "catalog only", "showcase", "online checkout", "hybrid", "deep link", "wa.me", "phone", "sales channel"],
      content: (
        <Card className="mb-6 border-border/80 shadow-xs">
          <CardHeader className="pb-3">
            <div className="flex flex-wrap items-center justify-between gap-2">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Configure checkout flow for your store. Standard online checkout is active by default for all existing and upcoming stores.
                </p>
              </div>
              <Badge variant="outline" className="text-xs border-primary/30 text-primary bg-primary/5">
                Channel Engine
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <Badge variant="outline" className={`text-[10px] ${
                          isSelected ? "border-primary/40 text-primary bg-primary/10" : "text-muted-foreground"
                        }`}>
                          {mode.badge}
                        </Badge>
                      </div>
                      <div>
                        <h4 className="font-semibold text-sm leading-tight text-foreground">{mode.title}</h4>
                        <p className="text-[11px] font-medium text-muted-foreground mt-0.5">{mode.subtitle}</p>
                      </div>
                      <p className="text-xs text-muted-foreground/90 leading-relaxed pt-1">{mode.desc}</p>
                    </div>
...
<div className="mb-6">
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  ...
                  {form.gst_enabled !== false ? (
                    ...
                    <Badge variant="secondary" className="text-[10px] text-muted-foreground bg-muted">
                      ○ Disabled (₹0 Tax Rate)
                    </Badge>
                  )}
                </div>
                <p className="text-xs text-muted-foreground max-w-xl">
                  When turned <strong className="text-foreground">OFF</strong>, 0% GST is calculated across all sales channels: POS counter billing, online carts, checkout, customer receipts, and database orders. Disable this if your business operates below the GST threshold or under composition scheme.
                </p>
              </div>
              <Switch
    ...
    },
    {
      ...
      description: "Customize receipt headers, GSTIN, FSSAI, WhatsApp support, and social handles with live preview.",
      keywords: ["printer", "thermal", "receipt", "header", "footer", "fssai", "gstin", "whatsapp", "social", "58mm", "80mm", "slip"],
      content: (
        <div className="mt-4">
