...
function Home() {
  ...
  return (
    <AppShell>
      ...
      {/* Sticky Frozen Category Bar (Always visible at top on scroll like Blinkit / Zepto / Amazon) */}
      <StickyCategoryBar
          ...
          {categoryProducts.length === 0 ? (
            <div className="py-12 text-center rounded-2xl border border-dashed border-border bg-card/50">
              <p className="text-sm text-muted-foreground">
                No items available in {selectedCategory} at this time.
              </p>
              <Button
                variant="outline"
                size="sm"
          ...
          <section className="mt-6">
            ...
            >
              ...
              <button
                type="button"
                onClick={() => setSelectedCategory(undefined)}
                className="group flex min-w-[76px] flex-col items-center gap-1.5 text-center text-xs transition-transform active:scale-95 shrink-0 cursor-pointer"
              >
