...
export function generateSampleCsv(vertical: string = "electronics_appliances"): string {
  ...
  if (vertical === "electronics_appliances") {
    sampleRows = [
      'Apple iPhone 15 128GB,Smartphones & Tablets,79900,82900,pc,15,Apple,A3090,12,true,"Aisle 1, Shelf A-1","RAM: 6GB | Storage: 128GB | Display: 6.1-inch Super Retina | Chip: A16 Bionic",101,"Flagship Apple smartphone with Dynamic Island and 48MP main camera"',
      'Samsung 55-inch 4K Crystal UHD TV,Smart TVs & Home Theatre,44990,52900,pc,8,Samsung,UA55CUE60AK,24,true,"Aisle 2, Rack TV-3","Screen: 55 inch | Resolution: 4K UHD | Refresh: 60Hz | Audio: 20W Dolby",102,"Immersive crystal 4K display with smart Tizen OS"',
      'Dell Inspiron 15 Core i5,Laptops & Computers,54990,62000,pc,12,Dell,Inspiron-3520,12,true,"Aisle 1, Shelf B-2","CPU: Intel i5 12th Gen | RAM: 16GB | SSD: 512GB NVMe | Screen: 15.6-inch FHD",103,"High-speed performance laptop for work and productivity"',
      'Boat Rockerz 450 Bluetooth Headphone,Audio & Headphones,1499,3990,pc,50,boAt,Rockerz-450,12,false,"Aisle 3, Bin H-1","Battery: 15 Hours | Driver: 40mm | Bluetooth: v5.0",104,"Wireless on-ear headphone with HD sound and comfortable ear cushions"',
    ];
  } else if (vertical === "clothing_fashion") {
    sampleRows = [
      'Men Pure Cotton Slim Fit Oxford Shirt,Men Casual & Formal,1299,1999,pc,40,Allen Solly,AS-SH-01,0,false,"Aisle A, Rack 2","Fabric: 100% Pure Cotton | Fit: Slim Fit | Sleeve: Full Sleeve | Pattern: Solid",201,"Classic breathable cotton shirt suitable for formal and casual wear"',
      'Women Printed Rayon Anarkali Kurti,Women Ethnic & Western,899,1599,pc,60,Biba,BB-AK-09,0,false,"Aisle B, Rack 1","Fabric: Premium Rayon | Length: Calf Length | Neck: Round Neck | Sleeve: 3/4th",202,"Elegant ethnic festive wear with gold foil print accents"',
      'Men Slim Straight Stretch Denim Jeans,Men Casual & Formal,1799,2999,pc,35,Levi\'s,511-SLIM,0,false,"Aisle A, Rack 4","Fabric: Cotton Stretch Denim | Waist: Mid Rise | Closure: Button & Zip",203,"Durable stretch denim engineered for all-day flexibility"',
    ];
  } else if (vertical === "grocery_supermarket") {
    sampleRows = [
      'Aashirvaad Shudh Chakki Atta 10kg,Atta Rice & Whole Grains,445,495,pack,100,Aashirvaad,AASH-10KG,0,false,"Aisle 1, Pallet 3","Type: 100% Whole Wheat | Fibre: High Fibre | Shelf Life: 3 Months",301,"Pure whole wheat flour processed with traditional stone chakki grinding"',
      'Tata Sampann Unpolished Toor Dal 1kg,Dals Pulses & Dry Fruits,175,195,kg,80,Tata Sampann,TS-TOOR-1K,0,false,"Aisle 2, Shelf D-2","Protein: 22g per 100g | Polish: Unpolished Natural",302,"Rich in dietary protein without any chemical polishing or coloring"',
      'Fortune Sunlite Refined Sunflower Oil 1L,Edible Oils & Ghee,135,160,pack,120,Fortune,FORT-SUN-1L,0,false,"Aisle 3, Shelf B-1","Enriched: Vitamin A & D | Zero Cholesterol",303,"Light and healthy edible cooking oil for everyday family meals"',
      'Amul Butter Pasteurised 500g,Dairy Bread & Eggs,275,285,pack,50,Amul,AMUL-BUT-500,0,false,"Dairy Chiller #1","Milk Fat: 80% | Storage: Refrigerate 4°C",304,"The classic Taste of India butter made from pure fresh cream"',
    ];
  } else {
    // Universal / Departmental
    sampleRows = [
      'Samsung 43-inch 4K Smart TV,Electronics,29990,36900,pc,10,Samsung,UA43CUE,24,true,"Aisle 1, Rack 1","Display: 4K UHD | Audio: 20W",401,"Crystal UHD smart entertainment display"',
      'Men Classic Polo T-Shirt,Fashion & Apparel,699,1199,pc,50,U.S. Polo,USP-PL-01,0,false,"Aisle 2, Rack 3","Fabric: 100% Cotton | Fit: Regular",402,"Everyday breathable pique polo"',
      'Daawat Rozana Gold Basmati Rice 5kg,Groceries,410,480,pack,40,Daawat,DW-BAS-5K,0,false,"Aisle 3, Shelf A",,,,"Aged long grain aromatic basmati rice"',
    ];
  }
...
export function parseProductsCsv(csvText: string): ParsedCsvResult {
  ...
  const priceIdx = rawHeaders.findIndex((h) => h === "price" || h === "mrp" || h === "rate");
